...
const questions = [
  ...
  {
    id: 51, name: "Longest Palindromic Substring",
    leetcode: "https://leetcode.com/problems/longest-palindromic-substring/",
    gfg: "https://www.geeksforgeeks.org/longest-palindromic-substring/",
    codechef: "https://www.codechef.com/problems/PALSTR",
    hackerrank: "https://www.hackerrank.com/challenges/palindrome-index/problem",
    platform_ids: { leetcode: "5", codechef: "PALSTR" },
    profile: ["Ninja", "Digital"],
  ...
  {
    id: 52, name: "Check if String is Palindrome (ignore case & spaces)",
    leetcode: "https://leetcode.com/problems/valid-palindrome/",
    gfg: "https://www.geeksforgeeks.org/c-program-check-given-string-palindrome/",
    codechef: "https://www.codechef.com/problems/PALIN",
    hackerrank: "https://www.hackerrank.com/challenges/game-of-thrones/problem",
    platform_ids: { leetcode: "125", codechef: "PALIN" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Two Pointer / String",
  ...
  {
    id: 53, name: "Palindrome Number Check (without string conversion)",
    leetcode: "https://leetcode.com/problems/palindrome-number/",
    gfg: "https://www.geeksforgeeks.org/check-if-a-number-is-palindrome/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "9" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Number System / Math",
    category: "Strings",
  ...
  {
    id: 55, name: "Minimum Insertions to Make String Palindrome",
    leetcode: "https://leetcode.com/problems/minimum-insertion-steps-to-make-a-string-palindrome/",
    gfg: "https://www.geeksforgeeks.org/minimum-number-of-insertions-to-form-a-palindrome/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "1312" },
    profile: ["Digital", "Prime"],
    difficulty: { Digital: "Hard", Prime: "Hard" },
    type: "Dynamic Programming",
    category: "Strings",
  ...
  {
    id: 57, name: "Check if Two Strings are Anagram (Sorted / Count)",
    leetcode: "https://leetcode.com/problems/valid-anagram/",
    gfg: "https://www.geeksforgeeks.org/check-whether-two-strings-are-anagram-of-each-other/",
    codechef: "https://www.codechef.com/problems/ANA",
  ...
  {
    id: 58, name: "Minimum Character Deletions to Make Anagram",
    leetcode: "https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram/",
    gfg: "https://www.geeksforgeeks.org/remove-minimum-number-characters-so-two-strings-become-anagram/",
    codechef: null,
    hackerrank: "https://www.hackerrank.com/challenges/making-anagrams/problem",
    platform_ids: { leetcode: "1347" },
    profile: ["Digital"],
    difficulty: { Digital: "Medium" },
    type: "Hashing / String",
    category: "Strings",
  ...
  // ── NEW NUMBER THEORY QUESTIONS ──
  {
    id: 67, name: "Reverse Digits of a Number",
    leetcode: "https://leetcode.com/problems/reverse-integer/",
    gfg: "https://www.geeksforgeeks.org/write-a-c-program-to-reverse-digits-of-a-number/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "7" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Number System / Math",
    category: "Number System",
  ...
  {
    id: 68, name: "Power of Two / Power of Three Check",
    leetcode: "https://leetcode.com/problems/power-of-two/",
    gfg: "https://www.geeksforgeeks.org/program-to-check-if-a-number-is-power-of-2/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "231" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
  ...
  {
    id: 69, name: "Sieve of Eratosthenes (All Primes up to N)",
    leetcode: "https://leetcode.com/problems/count-primes/",
    gfg: "https://www.geeksforgeeks.org/sieve-of-eratosthenes/",
    codechef: "https://www.codechef.com/problems/PRIME1",
    hackerrank: "https://www.hackerrank.com/challenges/sieve-of-eratosthenes/problem",
    platform_ids: { leetcode: "204", codechef: "PRIME1" },
    profile: ["Ninja", "Digital"],
    difficulty: { Ninja: "Medium", Digital: "Medium" },
    type: "Number System / Sieve",
    category: "Number System",
  ...
  {
    id: 70, name: "Sum of Digits Until Single Digit (Digital Root)",
    leetcode: "https://leetcode.com/problems/add-digits/",
    gfg: "https://www.geeksforgeeks.org/digital-rootrepeated-digital-sum-given-integer/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "258" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Number System / Math",
    category: "Number System",
  ...
  {
    id: 71, name: "Perfect Number Check",
    leetcode: "https://leetcode.com/problems/perfect-number/",
    gfg: "https://www.geeksforgeeks.org/perfect-number/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "507" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Number System / Math",
    category: "Number System",
  ...
  {
    id: 72, name: "Count Digits That Evenly Divide Number",
    leetcode: "https://leetcode.com/problems/count-digits-that-divide-a-number/",
    gfg: "https://www.geeksforgeeks.org/count-digits-in-a-number-that-divide-the-number/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "2520" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Number System / Math",
    category: "Number System",
  ...
  {
    id: 73, name: "Binary to Decimal / Decimal to Binary",
    leetcode: null,
    gfg: "https://www.geeksforgeeks.org/program-binary-decimal-conversion/",
    codechef: "https://www.codechef.com/problems/BINDEC",
    hackerrank: null,
    platform_ids: { codechef: "BINDEC" },
    profile: ["Ninja", "Digital"],
    difficulty: { Ninja: "Easy", Digital: "Easy" },
    type: "Number System / Bit Manipulation",
    category: "Number System",
    source: "GFG 2026",
  },
  {
    id: 74, name: "Swap Two Numbers Without Temp Variable",
    leetcode: null,
  ...
  {
    id: 75, name: "GCD of Array / Pairwise GCD",
  ...
  {
    id: 77, name: "Happy Number",
    leetcode: "https://leetcode.com/problems/happy-number/",
    gfg: "https://www.geeksforgeeks.org/happy-numbers/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "202" },
    profile: ["Ninja", "Digital"],
    difficulty: { Ninja: "Easy", Digital: "Easy" },
    type: "Number System / Math",
    category: "Number System",
  ...
  {
    id: 78, name: "Number of Steps to Reduce Number to Zero",
    leetcode: "https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/",
    gfg: "https://www.geeksforgeeks.org/count-steps-to-reduce-n-to-zero/",
    codechef: null,
    hackerrank: null,
    platform_ids: { leetcode: "1342" },
    profile: ["Ninja"],
    difficulty: { Ninja: "Easy" },
    type: "Bit Manipulation / Math",
    category: "Number System",
  ...
  {
    id: 79, name: "Excel Column Number / Title",
  ...
  {
    id: 80, name: "Modular Exponentiation (Fast Power)",
    leetcode: "https://leetcode.com/problems/powx-n/",
    gfg: "https://www.geeksforgeeks.org/modular-exponentiation-power-in-modular-arithmetic/",
    codechef: "https://www.codechef.com/problems/FASTPO",
    hackerrank: null,
    platform_ids: { leetcode: "50", codechef: "FASTPO" },
    profile: ["Digital", "Prime"],
    difficulty: { Digital: "Medium", Prime: "Hard" },
    type: "Number System / Recursion",
    category: "Number System",
    source: "Previous Years",
  },
  // ─── SERIES & APTITUDE ───────────────────────────────────────────────────
      ...
      <div style={{ background: "linear-gradient(135deg,#0f172a 0%,#1e1b4b 60%,#0f172a 100%)", borderBottom: "1px solid #1e293b", padding: "22px 24px 0" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p style={{ color: "#64748b", fontSize: 11, marginLeft: 34, marginBottom: 12 }}>
            {questions.length} coding questions (Arrays · Strings · Number Theory · DSA) + GFG 2026 study guide
          </p>
